          ...
          <div class="table-responsive">
            <table id="table_eto" class="table table-bordered">
              ...
              <tbody>
                ...
                <?php foreach (get_list("SELECT a.id,DATE_FORMAT(a.appointment_date, '%m-%d-%Y') as `appointment_date`,s.name as `status` from tbl_appointment a inner join tbl_appointment_status s on s.id = a.status_id where a.clinic_id=$cid") as $res) { ?>
                  <tr>
                    <td><?= $res['id'] ?></td>
                    <td><?= $res['srvc_name'] ?></td>
                    <td><?= $res['srvc_desc'] ?></td>
